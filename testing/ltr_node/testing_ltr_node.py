...
from ptranking.ltr_node.eval.ltr_node import NeuralDecisionEnsemblesLTREvaluator
...
if __name__ == '__main__':
    ...
    evaluator = NeuralDecisionEnsemblesLTREvaluator(cuda=cuda)
